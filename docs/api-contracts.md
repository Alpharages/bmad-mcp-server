...
**Use case:** Called by `bmad-clickup-create-story`, `bmad-clickup-dev-implement`, and
`bmad-clickup-code-review` at skill startup to locate planning artifacts regardless
