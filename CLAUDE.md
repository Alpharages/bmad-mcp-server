...
This project is indexed by GitNexus as **bmad-mcp-server** (5380 symbols, 8827 relationships, 225 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
